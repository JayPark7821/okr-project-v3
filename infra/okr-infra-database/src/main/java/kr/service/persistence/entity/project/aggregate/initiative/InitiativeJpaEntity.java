package kr.service.persistence.entity.project.aggregate.initiative;
...
public class InitiativeJpaEntity extends BaseEntity {
	...
	@Builder
	public InitiativeJpaEntity(TeamMemberJpaEntity teamMember, String name, LocalDate edt, LocalDate sdt,
		String detail) {

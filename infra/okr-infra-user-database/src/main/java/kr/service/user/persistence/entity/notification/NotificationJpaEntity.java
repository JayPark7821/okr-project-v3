package kr.service.user.persistence.entity.notification;
...
import kr.service.user.notification.NotificationType;
import kr.service.user.persistence.config.BaseEntity;
